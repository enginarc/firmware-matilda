...
void board_init_gpio(void) {
    ...
    io_conf_enc.pin_bit_mask = (1ULL << PIN_TWT_DIR1) | (1ULL << PIN_TWT_DIR2);
    ...
    gpio_isr_handler_add(PIN_TWT_DIR1, encoder_isr_handler, (void*) PIN_TWT_DIR1);
}